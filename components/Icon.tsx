...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  const icons: Record<IconName, React.ReactNode> = {
    ...
    'file-word': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" fill="none" stroke="#2563EB" />,
    'file-excel': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.5 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V8.5L14.5 3z" fill="#10B981" /><path strokeLinecap="round" strokeLinejoin="round" d="M14 3v5h5M8 12h8M12 8v8" stroke="#fff" strokeWidth="1.5" />,
    'file-pdf': <path fillRule="evenodd" clipRule="evenodd" d="M4 4a2 2 0 012-2h8l6 6v10a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm10 2V4h-2v2h2zm-2 4h4v2h-4v-2z" fill="#EF4444" />,
    'file-image': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l-1-1a2 2 0 010-2.828l1-1" />,
  ...
  const getIconContent = (name: IconName) => {
    if (['file-word', 'file-excel'].includes(name)) {
      return (
